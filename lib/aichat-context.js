...
function toolInstruction(tools) {
  ...
  return [
    ...
    "TOOL CALL PROTOCOL:",
    "When a tool is required, respond with exactly one JSON object or JSON array and no markdown or prose.",
    "Each call must use {\"tool\":\"name\",\"args\":{...}}. Use only these tools:",
