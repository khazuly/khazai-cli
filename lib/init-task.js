...
export const INIT_TOOLS = ["read", "glob", "grep", "bash", "websearch", "webfetch", "repo", "skill", "think"];
...
export function buildInitTaskPrompt({
  ...
  const lines = [
    ...
    "5. Use only read-only tools (read, glob, grep, and safe read-only shell). Never write, edit, delete, install, or mutate the workspace.",
    "",
    "Generation rules:",
