  ...
  async chat(messages, {
    ...
    try {
      ...
      onEvent?.({
        ...
        timings: {
          providerMessageConversionMs: messagesPreparedAt - preparationStartedAt,
          providerRequestPreparationMs: performance.now() - preparationStartedAt,
          requestBytes: Buffer.byteLength(JSON.stringify(body), "utf-8"),
        },
      });
