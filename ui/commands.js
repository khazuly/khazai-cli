...
export const COMMANDS = [
  ...
  { name: "/connect", description: "Connect a provider", category: "workspace", aliases: [], visible: true, group: "workspace" },
  { name: "/connections", description: "Manage provider connections", category: "workspace", aliases: [], visible: true, group: "workspace" },
